 ...
 * @author samuelc
 */
public class FieldSelectorZoomPanImageView extends ZoomPanImageView {
    ...
    public FieldSelectorZoomPanImageView(Image image, NucleiSelections inputNucleiSelection, Stage inputStage) {
