//package ij.plugin.GPEC.external; /// GPEC mod
...
* @author Jarek Sacha
*/
public class EntropyThreshold implements PlugInFilter {
 /*
  *
  */
  int autoThreshold; /// GPEC mod
 ...
 /// GPEC mod
 public int getAutoThreshold () {return autoThreshold;}
