...
public class ColourDeconvolutionEngine implements PlugIn {
...
// Read the paper!
//
    private HashMap<String, ImagePlus> images; /// GPEC mod - added hashtable to hold the result images
    private ImagePlus originalImp;              /// GPEC mod - the original image
    private ColourDeconvolutionConstants constants;
    private StainAnalyzerSettings settings;

    /**
     * constructor with no arguments for standalone application
     */
    public ColourDeconvolutionEngine() {
        images = null;
        originalImp = null;
        this.images = new HashMap<String, ImagePlus>();
        this.constants = ColourDeconvolutionConstants.getInstance();
    }
     ...
     * @param settings
     */
    public ColourDeconvolutionEngine(ImagePlus imp, StainAnalyzerSettings settings) {
        this.originalImp = imp;
    ...
    /**
     * method for running in stand-alone mode - for PlugIn interface
     *
     * @param arg
     */
    ...
    /**
     * do the actual color deconvolution and put the result images in the
     * hashtable (images)
     *
     * @param imp
     * @param myStain
     */
    public void deconvolute(String myStain) {
        ImagePlus imp = originalImp; // assume originalImp is NOT NULL!!!
        /*
        ...
        //} else {
        //    imp = WindowManager.getCurrentImage();
        //} // the above block is moved to run(arg)

        if (imp.getBitDepth() != 24) {
            IJ.error("RGB image needed. ... current image(" + imp.getTitle() + "), bit depth=" + imp.getBitDepth());
            return;
        }
...
// end of the commented out section by Landini
    ...
    /**
     * get images as an array list
     *
     * @return
     */
    public ArrayList<ImagePlus> getImages() {
        ArrayList<ImagePlus> imageArr = new ArrayList<ImagePlus>();
        TreeSet<String> sortedKeys = new TreeSet<String>();
        for (String key : images.keySet()) {
            sortedKeys.add(key);
        }
        for (String key : sortedKeys) {
            imageArr.add(images.get(key));
        }
        return imageArr;
    }
}
